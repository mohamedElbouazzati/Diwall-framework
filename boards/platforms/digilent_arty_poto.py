...
_io = [
    ...
    #SPI  
    (   "lora_spi", 0,
        Subsignal("clk" , Pins("F1")),           # MODIFY J6 SPI KIT CHIP ARDUINO
        Subsignal("cs_n", Pins("V17")),           # MODIFY J6 SPI KIT CHIP ARDUINO
        Subsignal("mosi", Pins("H1")),           # MODIFY J6 SPI KIT CHIP ARDUINO
